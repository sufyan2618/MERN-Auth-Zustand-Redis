...
const VerifyOTP = () => {
    ...
    const { VerifyOTP: verifyOTP, ResendOTP: resendOTP, isVerifyingOTP, isResendingOTP } = useAuthStore();
            ...
            <div className="w-full max-w-md">
                ...
                <div className="mt-6 bg-blue-50 rounded-2xl p-4 border border-blue-100">
                    <div className="flex items-start space-x-3">
                        ...
                        <div>
                            <p className="text-sm font-semibold text-blue-900 mb-1">Check your spam folder</p>
                            <p className="text-xs text-blue-700">If you don't see the email in your inbox, please check your spam or junk folder.</p>
                        </div>
                    </div>
                </div>
            </div>
